                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto ">
                        ...
                        <li class="nav-item"><a class="nav-link" id="show2" href="#!">Log in</a></li>
                                    ...
                                    <dialog id="FirstDialog">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-15">
                                                ...
                                                <input type="password" name="user-password" class="form-control" id="inputPassword" placeholder="รหัสผ่านต้องมีมากกว่า 6 ตัว" required >
                                            </div>
                                            <div class="form-group col-md-15">
                            ...
                            <li class="nav-item"><a class="nav-link" id="show3" href="#!">Admin</a></li>
                                ...
                                <div>
                                    <dialog id="thirdDialog">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                            <input type="text" name="admin-name" class="form-control" id="staticEmail" placeholder="Admin" required>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">
                                            ...
                                            <div class="col-sm-10">
                                            <input type="password" name="admin-password" class="form-control" id="inputPassword" placeholder="Password Admin" required>
                                            </div>
                                        </div>
                                        <center>
                                        <button type="submit" name="admin-login" value="Login" class="btn btn-primary">Log in</button>
                                        <button type="close" id="hide3" class="btn btn-primary">Close</button>
                                        </center> 
                                            <!--5.display message -->
                                                <span class = "text-danger">
                                                    <?php
                                    ...
                                    <script>
                                        (function () {
                                            var dialog = document.getElementById('thirdDialog');
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>ยินดีต้อนรับเข้าสู่เว็บไซต์ของพวกเรา</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <p>เว็บไซต์ของเราทำเกี่ยวกับการให้เกร็ดความรู้เกี่ยวกับสัตว์เลี้ยงของคุณ สามารถตั้งกระทู้เพื่อแชร์เรื่องราวหรือตั้งกระทู้เพื่อบอกเล่าเกี่ยวกับสัตว์เลี้ยงของคุณได้</p>
                        </div>
                    </div>
                </div>
            </div>
